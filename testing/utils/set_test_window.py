...
def set_test_window(conf, test_name):

    # print a blank page kirk for visual rendering on terminal
    th.send_cmd_to_screen(conf["main_session_name"], conf["filenpa_blank_page"])
    ...
    th.send_cmd_to_screen(conf["main_session_name"], "screen -r -d \""+conf[test_name]["session_name"]+"\"")
    # clear scrolling
    ...
    th.send_cmd_to_screen(conf[test_name]["session_name"], conf["direpa_cmds"])
